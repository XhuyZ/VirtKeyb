...
namespace KeyboardLib
{
    ...
    public class CKeyboard
    {
        ...
        public void MakeKorKeys()
        {
            ...
            _keys.Add(new CKey() { scanCode = 114, keyText = "XhuyZ", columnIdx = 13, rowIdx = 3 });
        ...
        public void MakeJpnKeys()
        {
            ...
            _keys.Add(new CKey() { scanCode = 9, keyChar = '8', keyShiftChar = '(', columnIdx = 8, rowIdx = 0 });
            _keys.Add(new CKey() { scanCode = 10, keyChar = '9', keyShiftChar = ')', columnIdx = 9, rowIdx = 0 });
            _keys.Add(new CKey() { scanCode = 11, keyChar = '0', keyShiftChar = '0', columnIdx = 10, rowIdx = 0 });
            _keys.Add(new CKey() { scanCode = 12, keyChar = '-', keyShiftChar = '=', columnIdx = 11, rowIdx = 0 });
            _keys.Add(new CKey() { scanCode = 13, keyChar = '^', keyShiftChar = '~', columnIdx = 12, rowIdx = 0 });
            _keys.Add(new CKey() { scanCode = 14, keyText = "BackS", columnIdx = 13, rowIdx = 0 });

            // Row 2
            _keys.Add(new CKey() { scanCode = 15, keyText = "Tab", columnIdx = 0, rowIdx = 1 });
            _keys.Add(new CKey() { scanCode = 16, keyChar = 'q', keyShiftChar = 'Q', columnIdx = 1, rowIdx = 1 });
            _keys.Add(new CKey() { scanCode = 17, keyChar = 'w', keyShiftChar = 'W', columnIdx = 2, rowIdx = 1 });
            _keys.Add(new CKey() { scanCode = 18, keyChar = 'e', keyShiftChar = 'E', columnIdx = 3, rowIdx = 1 });
            _keys.Add(new CKey() { scanCode = 19, keyChar = 'r', keyShiftChar = 'R', columnIdx = 4, rowIdx = 1 });
            _keys.Add(new CKey() { scanCode = 20, keyChar = 't', keyShiftChar = 'T', columnIdx = 5, rowIdx = 1 });
            _keys.Add(new CKey() { scanCode = 21, keyChar = 'y', keyShiftChar = 'Y', columnIdx = 6, rowIdx = 1 });
            _keys.Add(new CKey() { scanCode = 22, keyChar = 'u', keyShiftChar = 'U', columnIdx = 7, rowIdx = 1 });
            _keys.Add(new CKey() { scanCode = 23, keyChar = 'i', keyShiftChar = 'I', columnIdx = 8, rowIdx = 1 });
            _keys.Add(new CKey() { scanCode = 24, keyChar = 'o', keyShiftChar = 'O', columnIdx = 9, rowIdx = 1 });
            _keys.Add(new CKey() { scanCode = 25, keyChar = 'p', keyShiftChar = 'P', columnIdx = 10, rowIdx = 1 });
            _keys.Add(new CKey() { scanCode = 26, keyChar = '@', keyShiftChar = '`', columnIdx = 11, rowIdx = 1 });
            _keys.Add(new CKey() { scanCode = 27, keyChar = '[', keyShiftChar = '{', columnIdx = 12, rowIdx = 1 });
